<template>
  <div class="weui_cell">
    ...
    <div class="weui_cell_ft" v-if="!readonly" style="font-size:0">
      ...
      <input v-model="props_value" type="number" :name="name" class="vux-number-input" :style="{width: width+'px'}" number :readonly="!fillable" pattern="[0-9]*"/>
...
export default {
  ...
  computed: {
    disabledMin () {
      return typeof this.min === 'undefined' ? false : this.props_value <= this.min
    },
    disabledMax () {
