...
(function(window, document, exportName, undefined) {
    ...
    function preImgResize(that, image) {
        ...
        var kuanW = that.width;
        var kuanH = that.height;
        var toS = kuanW / imgW;
    ...
    function render(that) {
        ...
        ctx.lineWidth = 1;
        var canvasZoom = 1;
        var screenW = that.width;
        var screenH = that.height;
        var canvasW = screenW / canvasZoom;
        var canvasH = screenH / canvasZoom;
...
(function(window, document, exportName, undefined) {
    ...
    mPinchResize.prototype = {
        ...
        init: function() {
            var that = this;
            var obj = that.body.imgResizeObj;
            ...
            //手指移动背景
            if (that.canTouch == 1) {
                var mc = Hammer(this.touchObj[0], { touchAction: 'auto' });
