...
(function(win, doc, undefined) {
    ...
    ScratchCard.prototype.getRelativePostion = function(touch) {
        ...
        // fix the bug when canvas is scale
        return {
            top: (touch.pageY - offset.top - this.canvas.clientTop - parseInt(computed.paddingTop)) / (parseInt(computed.height) / this.canvas.height),
            left: (touch.pageX - offset.left - this.canvas.clientLeft - parseInt(computed.paddingLeft)) / (parseInt(computed.height) / this.canvas.height)
        };
    };
